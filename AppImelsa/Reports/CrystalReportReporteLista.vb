...
Public Class CrystalReportReporteLista
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrystalReportReporteLista.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppImelsa.CrystalReportReporteLista.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateInit() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalReportReporteLista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportReporteLista = New CrystalReportReporteLista()
        rpt.Site = Me.Site
        Return rpt
    End Function
